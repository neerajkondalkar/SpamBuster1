...
public class SmsAdapterChat extends RecyclerView.Adapter<SmsAdapterChat.SmsViewHolder>{
    private static final String TAG = " [MY_DEBUG] " + SmsAdapterChat.class.getSimpleName();

    ArrayList<String> sms_messages_list = new ArrayList<>();
    Context context;

    public  SmsAdapterChat(Context ct, ArrayList<String> array_list){
        this.context = ct;
    ...
    public void insert(int position, String new_sms) {
        ...
        Log.d(TAG, "SmsAdapterChat: insert(): adding a new message in adapter at index + " + position);
    ...
    public void append(int position, Collection new_messages){
        ...
        Log.d(TAG, "SmsAdapterChat: append(): appending at index " + position);
    ...
    public void onBindViewHolder(@NonNull SmsViewHolder holder, int position) {
        holder.chat_sms_text.setText(sms_messages_list.get(position).toString());
    }
